package hoang.pham.vm.repository;

import hoang.pham.vm.GatewayApp;
import hoang.pham.vm.config.Constants;
import hoang.pham.vm.config.audit.AuditEventConverter;
import hoang.pham.vm.domain.PersistentAuditEvent;
...
import static hoang.pham.vm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
